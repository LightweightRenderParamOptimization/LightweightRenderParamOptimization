...
class calculate:
    ...
    def begin_play(self):
        ...
        self.uobject.get_owner().bind_event('lightGBMcalculateSet',self.lightGBMcalculateSet)
    ...
    def load_models(self, LOD):
        if LOD == 30:
            self.SSIM_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD30data_SSIM.pkl', 'rb'))
            self.time_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD30data_time.pkl', 'rb'))
        elif LOD == 50:
            self.SSIM_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD50data_SSIM.pkl', 'rb'))
            self.time_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD50data_time.pkl', 'rb'))
        elif LOD == 100:
            self.SSIM_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD100data_SSIM.pkl', 'rb'))
            self.time_model = pickle.load(open(r'D:\UE4Project\MetaHuman\Content\Scripts\lightGBM\LOD100data_time.pkl', 'rb'))
        else:
            print('没有这个模型！')
